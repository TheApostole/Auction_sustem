...
public interface BidRepository extends JpaRepository<Bid, Integer> {
    ...
    @Query(value = """
            ...
            FROM bids b ORDER BY b.bid_date ASC LIMIT 1
            """,nativeQuery = true)
    ...
    @Query(value = """
            SELECT b.bidder_name AS bidderName,
                   b.bid_date AS bidDate
            FROM bids b WHERE b.bidder_name = (SELECT b.bidder_name FROM  bids b GROUP BY  b.bidder_name ORDER BY count(b.bidder_name) DESC  LIMIT 1
